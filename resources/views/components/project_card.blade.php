...
<a href={{$project->link}} target = '_blank' rel="noopener noreferrer" class="group">
    <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 w-full">
        <div class="relative w-full h-28 lg:h-36 aspect-video">
            <img src={{Storage::url($project->image)}} class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
        </div>
        <div class="p-6">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">
                {{html_entity_decode($project->title, ENT_QUOTES)}}
            </h3>
