        ...
        <form action="{{ route('cases.update', $case->id) }}" method="POST" enctype="multipart/form-data" id="caseForm">
            ...
            <div class="mb-4">
                ...
                <div class="mt-3" id="image-preview-container" style="display: none;">
                    <img id="preview-image" src='{{Storage::url($case->image)}}' alt="Preview" class="max-w-xs rounded-md border border-gray-300">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="6"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500">{{ $case->description }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
